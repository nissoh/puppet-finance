...
//         orchestrator = new Orchestrator(owner, _revenueDistributor, keeper, _referralCode, _gmxInfo);
...
//         // alice
//         uint256 _aliceBalanceBefore = IERC20(_token).balanceOf(alice);
//         vm.startPrank(alice);
//         _approve(address(orchestrator), _token, _assets);
//         orchestrator.deposit(_assets, _token, alice);
//         assertEq(orchestrator.puppetDepositAccount(_token, alice) - _aliceBalanceBefore, _assets, "_testPuppetDeposit: E0");
//         vm.stopPrank();
...
//         assertEq(orchestrator.puppetDepositAccount(_token, bob) - _bobBalanceBefore, _assets, "_testPuppetDeposit: E1");
//         vm.stopPrank();
...
//         assertEq(orchestrator.puppetDepositAccount(_token, yossi) - _yossiBalanceBefore, _assets, "_testPuppetDeposit: E2");
//         vm.stopPrank();
...
//     // function _testPuppetDepositETH(uint256 _assets, address _token) internal {
//     //     _dealERC20(_token, alice, _assets);
//     //     _dealERC20(_token, bob, _assets);
//     //     _dealERC20(_token, yossi, _assets);
