...
contract vePuppet is Ownable, ReentrancyGuard {
    ...
    event Deposit(address indexed provider, uint256 value, uint256 indexed locktime, DepositType deposit_type, uint256 ts);
    ...
    /// @param token_addr `ERC20 80PUPPET/20ETH BPT` token address
